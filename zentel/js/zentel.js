(function() {
  ...
  function setup() {
    ...
    canvas.parent('game-canvas'); // Attache à #game-canvas comme dans la version actuelle
  ...
  function windowResized() {
    let scaleFactor = min(windowWidth / (GRID_WIDTH * CELL_SIZE), windowHeight / (GRID_HEIGHT * CELL_SIZE));
    resizeCanvas((GRID_WIDTH * CELL_SIZE) * scaleFactor, (GRID_HEIGHT * CELL_SIZE) * scaleFactor);
  }
